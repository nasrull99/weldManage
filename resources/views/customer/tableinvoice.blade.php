                        ...
                        <td style="text-align:center;">
                            <div class="btn-group" role="group" aria-label="Actions">
                                <button type="button"
                                    ...
                                    data-url="{{ route('customer.invoices.view', ['customerId' => $invoice->customer_id, 'invoiceId' => $invoice->id]) }}">
...
$('#viewInvoiceModal').on('show.bs.modal', function (event) {
    ...
    var modal = $(this);
    modal.find('#invoiceModalBody').html('<div class="text-center py-5"><div class="spinner-border text-secondary" role="status"></div><div>Loading...</div></div>');
